...
void title()
{
    ...
    drawstring(100,360,"Rishabh D\t 1CR15CS129");
    glColor3f(1.0,0.0,0.0);
    drawstring(100,320,"Madhusoodhanan KM\t 1CR15CS089");
    glColor3f(1.0,0.0,0.0);
    drawstring(100,280,"6th CSE B");
    glColor3f(1.0,1.0,1.0);
...
/* WHILE EXECUTING IN THE TERMINAL, THESE ARE THE COMMANDS:

*********:~/Desktop/NOTES$ gcc bford.cpp -lGLU -lGL -lglut -lm -Wno-write-strings
*********~/Desktop/NOTES$ ./a.out 
